var ComponentsBootstrapTagsinput = function () {
    var t = function () {
        ...
        t.tagsinput({itemValue: "value", itemText: "text"}), $("#object_tagsinput_add").on("click", function () {
            t.tagsinput("add", {
                value: $("#object_tagsinput_value").val(),
                text: $("#object_tagsinput_city").val(),
                continent: $("#object_tagsinput_continent").val()
            })
        }), t.tagsinput("add", {value: 1, text: "Amsterdam", continent: "Europe"}), t.tagsinput("add", {
            value: 4,
            text: "Washington",
            continent: "America"
        }), t.tagsinput("add", {value: 7, text: "Sydney", continent: "Australia"}), t.tagsinput("add", {
            value: 10,
            text: "Beijing",
            continent: "Asia"
